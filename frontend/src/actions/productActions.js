...
export const listProducts=(keyword='',pageNumber='',brandQuery='')=> async(dispatch)=>{
    try{
        dispatch({type:PRODUCT_LIST_REQUEST})

        const {data}= await axios.get(`/api/products?keyword=${keyword}&brandQuery=${brandQuery}&pageNumber=${pageNumber}`)
